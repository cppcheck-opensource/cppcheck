...
#define tokenizeDebugListing(...) tokenizeDebugListing_(__FILE__, __LINE__, __VA_ARGS__)
    ...
    void directiveDump(const char (&code)[size], const char filename[], const Settings& settings, std::ostream& ostr) {
        ...
        preprocessor.preprocess("", files, outputList);
...
#define checkHdrs(...) checkHdrs_(__FILE__, __LINE__, __VA_ARGS__)
    ...
    void testDirectiveIncludeTypes() {
        ...
        const char dumpdata[] = "  <directivelist>\n"
                                ...
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"2\" str=\"#define some(a) a function-like macro\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                "      <token column=\"2\" str=\"define\"/>\n"
                                "      <token column=\"9\" str=\"some\"/>\n"
                                "      <token column=\"13\" str=\"(\"/>\n"
                                "      <token column=\"14\" str=\"a\"/>\n"
                                "      <token column=\"15\" str=\")\"/>\n"
                                "      <token column=\"17\" str=\"a\"/>\n"
                                "      <token column=\"19\" str=\"function\"/>\n"
                                "      <token column=\"27\" str=\"-\"/>\n"
                                "      <token column=\"28\" str=\"like\"/>\n"
                                "      <token column=\"33\" str=\"macro\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"3\" str=\"#undef macro\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                "      <token column=\"2\" str=\"undef\"/>\n"
                                "      <token column=\"8\" str=\"macro\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"4\" str=\"#ifdef macro\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                "      <token column=\"2\" str=\"ifdef\"/>\n"
                                "      <token column=\"8\" str=\"macro\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"5\" str=\"#elif some (complex) condition\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                ...
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"6\" str=\"#else\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                "      <token column=\"2\" str=\"else\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"7\" str=\"#endif\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                "      <token column=\"2\" str=\"endif\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"8\" str=\"#if some other condition\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                ...
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"9\" str=\"#pragma some proprietary content\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                ...
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"10\" str=\"#\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"11\" str=\"#ident some text\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                "      <token column=\"2\" str=\"ident\"/>\n"
                                "      <token column=\"8\" str=\"some\"/>\n"
                                "      <token column=\"13\" str=\"text\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"12\" str=\"#unknownmacro some unpredictable text\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                ...
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"13\" str=\"#warning some warning message\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
                                "      <token column=\"2\" str=\"warning\"/>\n"
                                "      <token column=\"10\" str=\"some warning message\"/>\n"
                                "    </directive>\n"
                                "    <directive file=\"test.c\" linenr=\"14\" str=\"#error some error message\">\n"
                                "      <token column=\"1\" str=\"#\"/>\n"
